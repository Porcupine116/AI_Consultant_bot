...
- минимальное число уточняющих вопросов;
- анализ фотографий и скриншотов моделями с поддержкой vision;
- отдельная кнопка с контактами компании;
- сбор имени и телефона только при передаче специалисту;
